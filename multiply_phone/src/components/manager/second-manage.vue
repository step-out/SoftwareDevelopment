<template>
  <div class="container">
    ...
    <el-table :data="filteredSecond" stripe style="width: 100%" :show-header="true"  height="80%" overflow: auto>
      <el-table-column label="内容" prop="goods" width="150" align="center"></el-table-column>
      <el-table-column label="用户名" prop="user" width="90" align="center"></el-table-column>
