<template>
  <div class="container">
    <el-row height="10%">
      ...
      <el-dialog title="添加新菜品" :visible.sync="DialogVisible" width="60%" :modal="false">
        <el-form :model="newmenu" label-width="60px">
    ...
    <el-table :data="filteredMenu" stripe style="width: 100%" :show-header="true"  height="85%" overflow: auto>
      <el-table-column label="菜名" prop="menu" width="140" align="center"></el-table-column>
      <el-table-column label="餐厅" prop="belong" width="90" align="center"></el-table-column>
