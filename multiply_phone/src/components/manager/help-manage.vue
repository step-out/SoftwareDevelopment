<template>
  <div class="container">
    ...
    <el-table :data="filteredHelp" stripe style="width: 100%" :show-header="true"  height="80%" overflow: auto>
      <el-table-column label="内容" prop="need" width="150" align="center"></el-table-column>
